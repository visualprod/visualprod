...
import br.com.visualprodi.services.CargoService;
...
public class CargoResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody Cargo obj) {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody Cargo obj) {
